...
如文献[8]中Strasdat等人提出的方法一样，本文所提出的ORB-SLAM2方法基于深度信息合成立体坐标系，进而提取图像特征。通过这种方法，本文所设计的系统能够处理双目相机或RGB-D相机的输入数据。与以上所有方法不同的是，ORB-SLAM2的后端是基于光束平差法的并且能够得到全局一致的稀疏重建结果。
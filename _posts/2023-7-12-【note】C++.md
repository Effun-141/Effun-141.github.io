...
*[翁凯老师C++课程笔记](https://www.bilibili.com/video/BV1dE41167hJ/)*
...
&emsp;&emsp;在头文件中包含类的声明（Class declaration）和函数的原型（prototypes），函数内容（body）放在.cpp中。注意调用头文件内容时要先include该头文件。

...
&emsp;&emsp;inline function 内联函数能够帮助减少overhead，提高成运行速度。与常规函数的区别在于内联函数的编译代码与其他程序代码“内联”起来了。编译器会使用相应的函数代码替换函数调用，也就是说，内联代码程序无序调到另一处执行代买再跳回来。因此，内联函数的运行速度比常规函数快。这是从汇编语言的层面上的理解方式！

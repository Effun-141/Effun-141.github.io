...
- [ESVIO](#ESVIO)
  ...
  - [功能包1：feature_tacker](#功能包1feature_tacker)
    ...
    - [3.sync_process()事件相机函数](#3sync_process()事件相机函数)
    - [4.handle_stereo_event函数](#4handle_stereo_event函数)
    - [5.FeatureTracker::trackImage函数](#5FeatureTracker::trackImage函数)
    - [6.FeatureTracker::trackEvent函数（非运动补偿）](#6FeatureTracker::trackEvent函数（非运动补偿)
    - [7.FeatureTracker::trackEvent函数（运动补偿）](#7FeatureTracker::trackEvent函数（运动补偿)
    - [8.EventDetector::createSAE_left函数（运动补偿）](#8EventDetector::createSAE_left函数（运动补偿)
